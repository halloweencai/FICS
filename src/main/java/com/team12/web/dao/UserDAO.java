...
public class UserDAO{
	...
	public User findById(int id) {
		...
		try {
			User instance = (User) getCurrentSession().get("com.jun.web.model.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) getCurrentSession().createCriteria("com.jun.web.model.User")
